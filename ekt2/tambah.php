    ...
    <div class="col-md-10 p-5 pt-5">
      ...
      <form method="POST" action="">
        <div class="form-group">
          ...
          <input type="text" class="form-control" id="nama" placeholder="nama lengkap" name="nama" autofocus autocomplete="off">
        ...
        <div class="form-group">
          ...
          <input type="text" class="form-control" id="nama" placeholder="sekolah asalmu" name="sekolah_asal" required autocomplete="off">
        </div>
        <div class="form-group">
          <label for="foto_maba">foto : </label>
          <input type="text" class="form-control" id="foto_maba" placeholder="foto anda" name="foto_maba" required autocomplete="off">
        </div>
